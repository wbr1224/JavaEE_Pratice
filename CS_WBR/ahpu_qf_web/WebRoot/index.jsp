...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	String code=ValidateUtil.createValidateCode();
...
<body style="background-image: url('https://pt.1000phone.net/static/img/fyzh_login1.824f963.jpg');background-repeat: no-repeat;background-size: 100% 100%">
